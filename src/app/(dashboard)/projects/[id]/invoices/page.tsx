    ...
    <div className="space-y-8 animate-in fade-in duration-200">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {view === 'list' ? (
          ...
          <Button 
            variant="ghost" 
            className="text-zinc-500 hover:text-foreground font-bold px-4 h-11 rounded-sm transition-all"
      ...
      {view === 'list' ? (
        <div className="space-y-8">
          <div className="grid gap-6 md:grid-cols-4">
            ...
            <Card className="bg-card border-border shadow-sm rounded-sm overflow-hidden group border-emerald-500/20 transition-all">
              <CardContent className="p-8">
            ...
            <Card className="bg-card border-border shadow-sm rounded-sm overflow-hidden group hover:border-rose-500/20 transition-all">
              <CardContent className="p-8">
          ...
          <Card className="bg-card border-border shadow-sm rounded-sm overflow-hidden">
                      ...
                      <tr key={inv.id} className="group hover:bg-zinc-50 transition-colors cursor-pointer">
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-4">
                            <div className="h-10 w-10 rounded-sm bg-zinc-100 flex items-center justify-center group-hover:bg-primary/5 group-hover:border-primary/20 transition-all">
                        ...
                        <td className="px-8 py-6">
                          <span className={cn(
                            "px-3 py-1 rounded-sm text-[10px] font-black border uppercase tracking-widest",
