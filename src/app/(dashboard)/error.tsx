  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center space-y-8 animate-in zoom-in-95 duration-150">
        ...
        {error.digest && (
          <div className="p-4 bg-zinc-50 border border-border rounded-xl font-mono text-[10px] text-zinc-500 flex items-center gap-3">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Button 
            onClick={reset}
            className="w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90 font-black px-10 h-11 rounded-xl shadow-xl shadow-primary/20 transition-all hover:scale-[1.02]"
          >
            <RotateCcw className="h-4 w-4 mr-2" />
            Restart Interface
          </Button>
          <Link href="/" className="w-full sm:w-auto">
            <Button variant="ghost" className="w-full text-zinc-500 hover:text-foreground hover:bg-zinc-100 font-black uppercase tracking-widest text-[10px] h-11 px-8 rounded-xl transition-all">
